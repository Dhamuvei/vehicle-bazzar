...
function MemberShip() {
  ...
  return (
    <>
      ...
      <section class="wrapper mwrapper">
        <div class="container">
          <div class="row">
            <div class="col-md-4">
              <div class="card text-white card-has-bg click-col bgm1 memcard">
                ...
                <div class="card-img-overlay d-flex flex-column">
                  <div class="card-body memcardbody">
                    <h3 class="card-title mt-0">Free plan</h3>
                    <hr />
                    ...
                    <br />
                    <p>Bike will Sale in Good prize</p>
                    <br />
                  </div>
                  <div class="card-footer justify-content-center memfcard">
                    <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                    
                      <Link to="/UserData1"><button class="btn btn-danger me-md-2" type="submit">
                          Next
                        </button></Link>
